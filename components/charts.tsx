...
export default function FinanceCharts() {
  ...
  return (
    ...
    <div className="flex flex-col gap-6 md:flex-row">
      ...
      <Card>
        <CardContent>
          <h2 className="text-xl font-bold mb-2">Annual Income/Outcome Increase (YoY)</h2>
          <ResponsiveContainer width="100%" height={300}>
            <BarChart data={annualData}>
              ...
              <Tooltip />
              <Legend />
              <Bar dataKey="incomeYoY" fill="#4caf50" name="Income YoY (%)" />
              <Bar dataKey="outcomeYoY" fill="#f44336" name="Outcome YoY (%)" />
            </BarChart>
          </ResponsiveContainer>
        </CardContent>
      </Card>
